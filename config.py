...
def load_settings():
    ...
    return Settings(
        ...
        rerank_top_score=_float_env("RERANK_TOP_SCORE", -10.0),
        rerank_avg_score=_float_env("RERANK_AVG_SCORE", -10.0),
        relevant_count_min=_int_env("RELEVANT_COUNT_MIN", 1),
        ...
        bm25_top_k=_int_env("BM25_TOP_K", 243),
        dense_top_k=_int_env("DENSE_TOP_K", 50),
        rrf_k=_int_env("RRF_K", 10),
